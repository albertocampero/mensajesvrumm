...
/*
function post(id, date) {
    var jsondata = JSON.stringify({"to" : "bk3RNwTe3H0:CI2k_HHwgIpoDKCIZvvDMExUdFQ3P1", "notification" : { "body" : "Nuevo mensaje.", "title" : "vrummapp.net", "icon" : "new" }, "data" : { "date" : date, "contents" : "http://vrummapp.net/msg/view.html?id="+id } });
    $.ajax({
        type : 'POST',
        url : "https://fcm.googleapis.com/fcm/send",
        headers : {
            Authorization : 'key=' + 'AIzaSyDmuC3AFbtQPH7ETatjpItmBHuHp_6EXwM'
        },
        contentType : 'application/json',
        dataType: 'json',
        /*data : {
...
/*{
    "to" : "bk3RNwTe3H0:CI2k_HHwgIpoDKCIZvvDMExUdFQ3P1...",
    "notification" : {
        "body" : "Hello World Notifications",
